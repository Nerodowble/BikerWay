...
describe('calculateRouteCost', () => {
  it('exports a R$6.50 default fuel price (2026-05 SP average)', () => {
    expect(DEFAULT_FUEL_PRICE_REAIS).toBe(6.5);
  });
  ...
  it('accepts the default fuel price constant', () => {
    ...
    // 60 / 30 = 2L; 2 * 6,50 = R$13
    expect(r.totalCost).toBeCloseTo(13, 6);
  });
});
